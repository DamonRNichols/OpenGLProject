...
void GPUPointEmitter::CreateDrawShader()
{
	LoadShaders("./shaders/gpu_particle_vert.glsl", 
		...
		"./shaders/gpu_particle_frag.glsl", &m_draw_shader);
}
...
void GPUPointEmitter::Draw(float a_curr_time, mat4 a_camera_transform, mat4 a_projection_view)
{
	...
	glUniform1f(min_lifetime_uniform, m_lifespan_min);
	glUniform1f(max_lifetime_uniform, m_lifespan_max);
